 ...
 *
 */
class ListUnordered extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'ListUnordered';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'UL';
	 ...
	 */
	protected static $lexingPattern = array('/^\[UL\]$/', '/^\[\/UL\]$/');
	protected static $lexingHtml = array('<ul>', '</ul>');
