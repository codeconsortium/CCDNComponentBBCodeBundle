 ...
 *
 */
class Heading2 extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'Heading2';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'H2';
	 ...
	 */
	protected static $lexingPattern = array('/^\[H2\]$/', '/^\[\/H2\]$/');
	protected static $lexingHtml = array('<h2>', '</h2>');
