 ...
 *
 */
class Bold extends LexemeBase implements LexemeInterface
{
    /**
     *
     * @var string $canonicalLexemeName
     */
    protected static $canonicalLexemeName = 'Bold';

    /**
     *
     * @var string $canonicalTokenName
     */
    protected static $canonicalTokenName = 'B';
     ...
     */
    protected static $lexingPattern = array('/^\[B\]$/', '/^\[\/B\]$/');
     ...
     */
    protected static $lexingHtml = array('<b>', '</b>');
