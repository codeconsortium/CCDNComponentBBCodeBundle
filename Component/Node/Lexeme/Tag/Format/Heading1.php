 ...
 *
 */
class Heading1 extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'Heading1';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'H1';
	 ...
	 */
	protected static $lexingPattern = array('/^\[H1\]$/', '/^\[\/H1\]$/');
	 ...
	 */
	protected static $lexingHtml = array('<h1>', '</h1>');
