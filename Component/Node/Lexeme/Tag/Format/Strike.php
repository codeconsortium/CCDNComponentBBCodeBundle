 ...
 *
 */
class Strike extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'Strike';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'STRIKE';
	 ...
	 */
	protected static $lexingPattern = array('/^\[STRIKE\]$/', '/^\[\/STRIKE\]$/');
	protected static $lexingHtml = array('<del>', '</del>');
