 ...
 *
 */
class ListItem extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'ListItem';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'LI';
	 ...
	 */
	protected static $lexingPattern = array('/^\[LI\]$/', '/^\[\/LI\]$/');
	protected static $lexingHtml = array('<li>', '</li>');
