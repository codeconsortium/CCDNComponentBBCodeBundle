 ...
 *
 */
class SuperScript extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'SuperScript';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'SUP';
	 ...
	 */
	protected static $lexingPattern = array('/^\[SUP\]$/', '/^\[\/SUP\]$/');
	protected static $lexingHtml = array('<sup>', '</sup>');
