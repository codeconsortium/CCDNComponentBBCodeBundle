 ...
 *
 */
class Italic extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'Italic';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'I';
	 ...
	 */
	protected static $lexingPattern = array('/^\[I\]$/', '/^\[\/I\]$/');
	protected static $lexingHtml = array('<i>', '</i>');
