 ...
 *
 */
class ListOrdered extends LexemeBase implements LexemeInterface
{
	/**
	 * 
	 * @var string $canonicalLexemeName
	 */
	protected static $canonicalLexemeName = 'ListOrdered';
	
	/**
	 * 
	 * @var string $canonicalTokenName
	 */
	protected static $canonicalTokenName = 'OL';
	 ...
	 */
	protected static $lexingPattern = array('/^\[OL\]$/', '/^\[\/OL\]$/');
	protected static $lexingHtml = array('<ol>', '</ol>');
